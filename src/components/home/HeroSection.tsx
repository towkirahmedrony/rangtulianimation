      ...
      <Container className="relative z-10 flex min-h-[560px] items-center pb-10 pt-16 md:min-h-[690px] md:pt-20">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col gap-4 animate-fade-up-delay-3 sm:flex-row">
            {/* Primary Button -> ওয়েবসাইটে রাখার জন্য */}
            <CTAButton 
              href="/episodes" 
              variant="primary" 
              showIcon 
            ...
            {/* Secondary Button -> ইউটিউব লোগোসহ */}
            <CTAButton
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="mr-2 h-5 w-5 text-red-500 transition-colors duration-300 group-hover:text-red-400"
              >
